...
4. 対象VRMプロジェクトの **dev serverが起動中**（例: `cd H:/aituber-vrm && npm run dev`）
...
- **プロジェクト固有**: test-artifacts はユーザーのプロジェクト配下（例: `H:/aituber-vrm/test-artifacts/vrm-review-YYYY-MM-DD/`）
...
- グローバル指示: `~/.copilot/copilot-instructions.md`
- 元ネタ記事: soyukke「opencode + GPT-5.4 screenshot review」
- 運用ガイド: Obsidian `[[copilot-pro-ops-guide]]`
- AITuber VRMプロジェクト: `H:/aituber-vrm/CLAUDE.md`
